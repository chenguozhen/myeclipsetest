 ...
 * @throws IllegalArgumentException 
  */
	//以下变量无需更改
	public static String packageName="com.dv.dao"; //要生成的DAO所在的包名
	...
	//以下变量每次生成不同的DAO时必须更改
	public static String daoName="StoreGoodsClass"; //要生成的DAO名称
	public static String tableName="app_goods_class";//数据表名称
	
	
	public static boolean getMySql=false;//是否生成数据库
